const ITEMS = [
    { id: 'xp_booster_2x', name: 'XP Booster 2x', emoji: '<:XPBooster2x:1510785824512413716>', desc: 'Double XP sementara (1 jam)', price: 3000, category: 'Booster' },
    { id: 'xp_booster_3x', name: 'XP Booster 3x', emoji: '<:XPBooster3x:1510785750134816878>', desc: 'Triple XP sementara (1 jam)', price: 7000, category: 'Booster' },
    { id: 'streak_shield', name: 'Streak Shield', emoji: '🛡️', desc: 'OTOMATIS lindungi streak jika skip 1 hari', price: 5000, category: 'Proteksi' },
    { id: 'lucky_charm', name: 'Lucky Charm', emoji: '<:LuckyCharm:1510785822713184376>', desc: '+15% chance menang semua game', price: 8000, category: 'Luck' },
    { id: 'money_magnet', name: 'Money Magnet', emoji: '<:MoneyMagnet:1510785821123281079>', desc: '+50% money dari semua sumber (1 jam)', price: 6000, category: 'Booster' },
    { id: 'daily_doubler', name: 'Daily Doubler', emoji: '📅', desc: 'Gandakan /daily reward (sekali pakai)', price: 2000, category: 'Economy' },
    { id: 'tax_free_voucher', name: 'Tax-Free Voucher', emoji: '<:TaxFreeVoucher:1510785819030454343>', desc: 'Gift tanpa pajak (sekali pakai)', price: 1500, category: 'Economy' },
    { id: 'lucky_spin_token', name: 'Lucky Spin Token', emoji: '🎫', desc: 'Jamin 2 simbol sama di slot (sekali pakai)', price: 4000, category: 'Luck' },
    { id: 'mystery_box', name: 'Mystery Box', emoji: '<:MysteryBox:1510785713984110657>', desc: 'Random 50-2000 money', price: 1000, category: 'Special' },
    { id: 'refine_stone', name: 'Refine Stone', emoji: '<:RefineStone:1510785817688412170>', desc: 'Material untuk upgrade relic (+1)', price: 3000, category: 'Battle' },
    { id: 'protection_stone', name: 'Protection Stone', emoji: '🛡️', desc: 'Refine gagal tidak turun level', price: 8000, category: 'Battle' },
    { id: 'auto_harvest_pass', name: 'Auto-Harvest Pass', emoji: '<:AutoHarvestPass:1510785815889055775>', desc: 'Aktifkan notifikasi panen otomatis (permanen)', price: 5000, category: 'Special' },
    { id: 'rod_part', name: 'Rod Parts', emoji: '<:RodParts:1510785813741441126>', desc: 'Material upgrade joran (dari mancing/shop)', price: 5000, category: 'Fishing' },
];
