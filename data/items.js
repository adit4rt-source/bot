const ITEMS = [
    ...
    { id: 'omega_core', name: 'Omega Core', emoji: '🔱', menuEmoji: '🔱', desc: 'Material legendaris untuk Awakening Cosmic — Hanya dari Boss Omega Genesis', price: 0, category: 'Special' },
    // Ascendant endgame (Nightmare / skill craft)
    { id: 'nightmare_token', name: 'Nightmare Token', emoji: '🌑', menuEmoji: '🌑', desc: 'Currency Nightmare Dungeon — tukar di Nightmare Shop', price: 0, category: 'Battle' },
    { id: 'skill_tome', name: 'Skill Tome', emoji: '📖', menuEmoji: '📖', desc: 'Reroll 1 battle skill pet (pilih tier). Hanya dari Nightmare Shop', price: 0, category: 'Battle' },
