...
const FARM_CROPS = [
    { id: 'gandum', name: 'Gandum', emoji: '🌾', tier: 'Common', cost: 20, time: 2, minYield: 2, maxYield: 4, sellPrice: 12, seasons: { spring: 'in', summer: 'off', autumn: 'peak', winter: 'wrong' } },
    { id: 'wortel', name: 'Wortel', emoji: '🥕', tier: 'Common', cost: 30, time: 3, minYield: 2, maxYield: 3, sellPrice: 15, seasons: { spring: 'in', summer: 'off', autumn: 'peak', winter: 'wrong' } },
    { id: 'bayam', name: 'Bayam', emoji: '🥬', tier: 'Common', cost: 20, time: 2, minYield: 3, maxYield: 5, sellPrice: 10, seasons: { spring: 'in', summer: 'off', autumn: 'peak', winter: 'wrong' } },
    { id: 'jagung', name: 'Jagung', emoji: '🌽', tier: 'Common', cost: 35, time: 4, minYield: 2, maxYield: 4, sellPrice: 15, seasons: { spring: 'in', summer: 'off', autumn: 'peak', winter: 'wrong' } },
    { id: 'kentang', name: 'Kentang', emoji: '🥔', tier: 'Common', cost: 25, time: 3, minYield: 2, maxYield: 4, sellPrice: 12, seasons: { spring: 'in', summer: 'off', autumn: 'peak', winter: 'wrong' } },
    { id: 'bawang_putih', name: 'Bawang Putih', emoji: '🧄', tier: 'Common', cost: 30, time: 4, minYield: 2, maxYield: 3, sellPrice: 15, seasons: { spring: 'in', summer: 'off', autumn: 'peak', winter: 'wrong' } },
    { id: 'tomat', name: 'Tomat', emoji: '🍅', tier: 'Uncommon', cost: 70, time: 8, minYield: 2, maxYield: 4, sellPrice: 25, seasons: { spring: 'off', summer: 'peak', autumn: 'in', winter: 'wrong' } },
    { id: 'cabai', name: 'Cabai', emoji: '🌶️', tier: 'Uncommon', cost: 60, time: 8, minYield: 3, maxYield: 5, sellPrice: 20, seasons: { spring: 'off', summer: 'peak', autumn: 'in', winter: 'wrong' } },
    { id: 'paprika', name: 'Paprika', emoji: '🫑', tier: 'Uncommon', cost: 80, time: 12, minYield: 2, maxYield: 3, sellPrice: 35, seasons: { spring: 'off', summer: 'peak', autumn: 'in', winter: 'wrong' } },
    { id: 'strawberry', name: 'Strawberry', emoji: '🍓', tier: 'Uncommon', cost: 100, time: 18, minYield: 2, maxYield: 4, sellPrice: 40, seasons: { spring: 'peak', summer: 'wrong', autumn: 'off', winter: 'in' } },
    { id: 'bawang_merah', name: 'Bawang Merah', emoji: '🧅', tier: 'Uncommon', cost: 60, time: 10, minYield: 3, maxYield: 5, sellPrice: 20, seasons: { spring: 'peak', summer: 'wrong', autumn: 'off', winter: 'in' } },
    { id: 'terong', name: 'Terong', emoji: '🍆', tier: 'Uncommon', cost: 75, time: 12, minYield: 2, maxYield: 3, sellPrice: 30, seasons: { spring: 'off', summer: 'peak', autumn: 'in', winter: 'wrong' } },
    { id: 'anggur', name: 'Anggur', emoji: '🍇', tier: 'Rare', cost: 200, time: 20, minYield: 2, maxYield: 4, sellPrice: 55, seasons: { spring: 'in', summer: 'peak', autumn: 'off', winter: 'wrong' } },
    { id: 'semangka', name: 'Semangka', emoji: '🍉', tier: 'Rare', cost: 250, time: 30, minYield: 1, maxYield: 2, sellPrice: 130, seasons: { spring: 'in', summer: 'peak', autumn: 'off', winter: 'wrong' } },
    { id: 'kopi', name: 'Kopi', emoji: '☕', tier: 'Rare', cost: 280, time: 30, minYield: 2, maxYield: 3, sellPrice: 80, seasons: { spring: 'off', summer: 'in', autumn: 'peak', winter: 'wrong' } },
    { id: 'kakao', name: 'Kakao', emoji: '🍫', tier: 'Rare', cost: 250, time: 35, minYield: 2, maxYield: 3, sellPrice: 70, seasons: { spring: 'off', summer: 'in', autumn: 'peak', winter: 'wrong' } },
    { id: 'blueberry', name: 'Blueberry', emoji: '🫐', tier: 'Rare', cost: 200, time: 20, minYield: 2, maxYield: 4, sellPrice: 60, seasons: { spring: 'in', summer: 'peak', autumn: 'off', winter: 'wrong' } },
    { id: 'mawar', name: 'Mawar', emoji: '🌹', tier: 'Rare', cost: 350, time: 35, minYield: 1, maxYield: 3, sellPrice: 130, seasons: { spring: 'peak', summer: 'in', autumn: 'off', winter: 'wrong' } },
    { id: 'bunga_matahari', name: 'Bunga Matahari', emoji: '🌻', tier: 'Epic', cost: 600, time: 50, minYield: 2, maxYield: 4, sellPrice: 130, seasons: { spring: 'peak', summer: 'in', autumn: 'off', winter: 'wrong' } },
    { id: 'jeruk', name: 'Jeruk', emoji: '🍊', tier: 'Epic', cost: 700, time: 70, minYield: 2, maxYield: 3, sellPrice: 200, seasons: { spring: 'off', summer: 'peak', autumn: 'in', winter: 'wrong' } },
    { id: 'zaitun', name: 'Zaitun', emoji: '🫒', tier: 'Epic', cost: 900, time: 90, minYield: 1, maxYield: 3, sellPrice: 350, seasons: { spring: 'off', summer: 'peak', autumn: 'in', winter: 'wrong' } },
